  ...
  return (
    <footer className="Footer container">
      ...
      <div className="Footer__MainLinks">
        {Object.keys(FOOTER_MAIN_LINKS).map((key) => (
          <div className="Footer__MainContainer" key={key}>
            <h3 className="Footer__MainTitle">{key}</h3>
            <ul>
              {FOOTER_MAIN_LINKS[key].map((link: string) => (
                <li key={link} className="Footer__MainLink">
                  <a href="/#" className="Footer__MainLinkTag">
                    {link}
                  </a>
                </li>
              ))}
        ...
        <div className="Footer__MainContainer Footer__MainContainer--icons">
          <ul className="Footer__MainContainerIcons">
            {FOOTER_MAIN_ICONS.map((icon) => (
              <li key={icon.href} className="Footer__MainContainerLi">
                <a
                  href={icon.href}
                  title={icon.title}
      ...
      <div className="Footer__GeneralInfo">
        {Object.keys(FOOTER_GENERAL_INFO).map((key) => (
          <div className="Footer__GeneralContainer" key={key}>
            <h3 className="Footer__MainTitle">{key}</h3>
            <div className="Footer__GeneralLinkWrap">
              {Object.keys(FOOTER_GENERAL_INFO[key]).map((keyCase) => (
                <ul key={keyCase} className="Footer__GeneralLinkWrapper">
                  <li className="Footer__GeneralTitle">{keyCase}</li>
                  {FOOTER_GENERAL_INFO[key][keyCase].map((link: string) => (
                    <li key={link} className="Footer__MainLink">
                      <a href="/#" className="Footer__MainLinkTag">
                        {link}
                      </a>
      ...
      <ul className="Footer__MainContainerIcons--mobile Footer__MainContainerIcons">
        {FOOTER_MAIN_ICONS.map((icon) => (
          <li key={icon.href} className="Footer__MainContainerLi">
            <a
              href={icon.href}
      ...
      <div className="Footer__Right">
        ...
        <p className="Footer__RightText">
          Copyright © 2009-2020 TopTechPhoto. All rights reserved.
        </p>
        <div className="Footer__Tools">
          <a
            href="//pics.io/terms-of-service"
            rel="nofollow"
            className="Footer__RightLink"
          >
            Terms of Service
          </a>
          <span className="Footer__Sep">|</span>
          <a
            href="//pics.io/privacy-policy"
            rel="nofollow"
            className="Footer__RightLink"
          >
            Privacy Policy
